---
title: A list of Windows Shell folder shortcuts
date: 2024-10-31
last_modified_at: 2024-11-13
excerpt: Provide quick access to commonly used directories without needing to know exact paths or settings.
tags:
  - shell
  - folder
  - shortcuts
...
| Display 32-bit programs stored on 64-bit Windows | shell:ProgramFilesX86 |
...
| Open the Common Files for 32-bit programs stored on 64-bit Windows | shell:ProgramFiles**Common**X86 |
...
| Open the Public Start Menu folder | shell:Common |
...
| Open the Windows System folder for 32-bit files on 64-bit Windows | shell:Systemx86 |
| Open the Windows installation folder | shell:Windows |
